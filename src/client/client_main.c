...
{*/
  ...
  ssds_js_cr_insert_code(json_gen, 123); //insert code into json
  ...
  ssds_js_cr_insert_code(json_msg, 10); //code for sending system.solv file, this code can change in time
